/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5cff75682ea3309a1cefffcb8c968c82)
// Runtime types generated with workerd@1.20260702.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EXTRACTION_MODEL: "~google/gemini-pro-latest";
	EXTRACTION_REASONING_EFFORT: "low";
	OPENROUTER_API_KEY: string;
	ListSessionAgent: DurableObjectNamespace<import("./src/server/index").ListSessionAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "ListSessionAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXTRACTION_MODEL" | "EXTRACTION_REASONING_EFFORT" | "OPENROUTER_API_KEY">> {}
}
