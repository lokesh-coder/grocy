// Uses the browser's native SpeechRecognition (Web Speech API) instead of
// recording audio for Whisper. This is genuinely live (streaming interim
// results as you speak, no chunk-cutting/guessing) and - per published
// benchmarks - meaningfully more accurate on Tamil than Whisper. It only
// works reliably on Chrome (desktop and Android); notably it does NOT work
// for Tamil on iOS Safari.
